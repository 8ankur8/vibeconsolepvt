  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-900 via-purple-800 to-indigo-900 text-white p-4 flex flex-col">
      ...
      <div className="flex-1 mb-4 relative">
        <canvas
          ref={canvasRef}
          className="w-full h-full bg-gray-800 rounded-lg border-4 border-purple-600 touch-none"
      ...
      <div className="grid grid-cols-3 gap- items-end">
        {/* D-Pad */}
        <div className="fixed left-[30%] bottom-[20%] w-32 h-32 mx-auto">
          <div className="absolute inset-0 bg-gray-800 rounded-full border-4 border-gray-700">
            {/* Up */}
            <button 
              onClick={() => handleDpadPress('up')}
              className="absolute top-0 left-1/2 transform -translate-x-1/2 w-8 h-8 bg-gray-700 hover:bg-gray-600 rounded-full flex items-center justify-center transition-colors"
            >
            ...
            <button 
              ...
              className="absolute bottom-0 left-1/2 transform -translate-x-1/2 w-8 h-8 bg-gray-700 hover:bg-gray-600 rounded-full flex items-center justify-center transition-colors"
            >
            ...
            <button 
              ...
              className="absolute left-0 top-1/2 transform -translate-y-1/2 w-8 h-8 bg-gray-700 hover:bg-gray-600 rounded-full flex items-center justify-center transition-colors"
            >
            ...
            <button 
              ...
              className="absolute right-0 top-1/2 transform -translate-y-1/2 w-8 h-8 bg-gray-700 hover:bg-gray-600 rounded-full flex items-center justify-center transition-colors"
            >
