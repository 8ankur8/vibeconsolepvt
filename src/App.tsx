    ...
    <div className="min-h-screen bg-[#1f252a] backdrop-blur-md border-b border-white/10 flex flex-col justify-center w-full text-white">
      ...
      <section className="pt-32 pb-20 w-full text-center px-4 " >
        ...
        <button 
          ...
          className="hover:bg-indigo-600 text-white px-8 py-3 bg-[#c48c4b] rounded-md blur-[25px] shadow-[0px_0px_12px_#ffaa3e] transition-colors shadow-[0px_0px_12px_#ffaa3e]"
        >
          Start Playing Free
        </button>
