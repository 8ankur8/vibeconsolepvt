...
function App() {
  ...
  const LandingPage = () => (
    <div className="min-h-screen bg-[#1f252a] backdrop-blur-md border-b border-white/10 flex flex-col justify-center w-full text-white">
      {/* Navigation */}
      <nav className="w-full z-50 backdrop-blur-md border-b border-white/10">
  ...
  <div class="absolute inset-0 bg-white rounded-lg mask mask-border"></div>
  <div class="relative p-4 bg-white rounded-lg">
    Gradient Border Example
      ...
      <section className="pt-32 pb-20 text-center px-4">
        <h1 className="text-4xl md:text-6xl font-bold mb-6 bg-gradient-to-r from-indigo-300 via-purple-300 to-pink-300 bg-clip-text text-transparent">
          Real-time multiplayer<br />gaming made simple
        </h1>
